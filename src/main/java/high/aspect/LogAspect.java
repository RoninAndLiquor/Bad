...
public class LogAspect {
	 ...
	 */
	@Pointcut("execution(* high.controller..*.*(..))")
    ...
    public void doAfterReturningAdvice1(JoinPoint joinPoint,Object keys){  
        ...
        System.out.println(getDateStr()+"返回值:"+JSON.toJSONString(keys));
    ...
    /**
     * 
     * TODO 方法作用：后置最终通知（目标方法只要执行完了就会执行后置通知方法） 
     * @param joinPoint
     * @Author: 蒋帅锋
     * @Date: 2017年12月26日 下午5:16:40
     */
    @After("pointcut()")  
    public void doAfterAdvice(JoinPoint joinPoint){  
        System.out.println(""+getDateStr()+"后置通22知执行了!");  
    } 
